...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if (!DatabaseConnection.instance) {
      ...
      console.log("%c Conectado a la base de datos", COLORS.green);
    }
  ...
  public connect(): void {
    ...
    if (!this.connected) {
      this.connected = true;
      console.log("\n%c Nueva conexion a la base de datos", COLORS.blue);
      return;
    }

    console.log("\n%c Ya existe una conexión activa", COLORS.red);
  }
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      ...
      console.log("\n%c Desconectamos conexion a la base de datos", COLORS.pink);
      return;
    }

    console.log("\n%c No hay conexión activa", COLORS.red);
  }
}
...
function main() {
  ...
  console.log("\n Son iguales:", db1 === db2); // Debería mostrar true
